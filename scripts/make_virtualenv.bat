...
:: work machines using Dropbox, but they have have Python installed
:: at different paths (because my %SystemDrive% isn't C: on one of them)
:: So a virtualenv created on one machine doesn't work on the other.
:: So I have to create a new virtualenv whenever I switch between them.
:: This script automates that. It shouldn't affect anything that is
:: checked into the repo. -Jonathan
